...
public class Pitch {
    ...
    private final static Pitch C = new Pitch('6');
     ...
     */
    public Pitch(char c) {
        List<Character> semitones = new ArrayList<>(Arrays.asList('1','2','3','4','5','6','7','8','9','0','-','='));
        if(semitones.contains(c))
            this.value =semitones.indexOf(c);
        else
            throw new IllegalArgumentException(c+" should be between 1 and =");
